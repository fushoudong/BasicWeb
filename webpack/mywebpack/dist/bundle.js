...
console.log((0, _exports.add)(10, 20));
console.log((0, _exports.mul)(10, 20));

console.log({
  name: _exports.name,
  age: _exports.age,
  height: _exports.height
});
setTimeout(function () {
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./mainCss.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./mainCss.css");
